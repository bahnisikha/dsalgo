Feature: Linked List page validation dsalgo
  ...
  Scenario: User enters valid Python code and Presented with  Result
    ...
    When User Enters "print('Hello, world!')" in the Editor of introduction page
  ...
  Scenario: User run the code in tryEditor with valid input for Types of Linked List page
    ...
    When The user Enter valid python code "print('Types of Linked List page')" in types of linked list page
  ...
  Scenario: User enters valid Python code and Presented with  Result
    ...
    And User Enters  invalid python code "print('Hello, world!')" in implementation link list in python
  ...
  Scenario: User run the code in tryEditor with valid input for Traversal page
    ...
    When The user Enter valid python code "print('Traversal')" in traversal page
