...
public class Array_SD {
	...
	@Given("The user opens Home Page and try enter array page")
	public void the_user_opens_home_page_and_try_enter_array_page() {
		array.homepage();
	}
	...
	@Then("The user should be redirected arraykpage")
	public void the_user_should_be_redirected_arraykpage() {
